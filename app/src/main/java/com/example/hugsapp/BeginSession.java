...
//                updateConnectionState("Disconnected");
    ...
    public void setData(int dataSelection) {
        if (dataSelection == 1) {
            video.setBackground(getApplicationContext().getDrawable(R.drawable.select_shape));
            ...
            force.setBackground(getApplicationContext().getDrawable(R.drawable.select_shape));
        }
    }
//    @Override
